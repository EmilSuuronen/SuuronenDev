...
const finnishTranslations: Record<string, string> = {
  ...
  "Enter a name for the new folder.": "Anna uudelle kansiolle nimi.",
  "Rename folder": "Nimea kansio uudelleen",
  "Enter a new name for this folder.": "Anna tälle kansiolle uusi nimi.",
  "Move to Trash": "Siirra roskakoriin",
  Reset: "Nollaa",
  "Reset desktop state": "Nollaa työpöydän tila",
  "Start from a clean desktop": "Aloita puhtaalta työpöydältä",
  "This clears saved notes, window state, theme, language, filters, and desktop icons from this browser.": "Tämä poistaa tallennetut muistiinpanot, ikkunoiden tilan, teeman, kielen, suodattimet ja työpöydän ikonit tästä selaimesta.",
  "Desktop layout and icon positions": "Työpöydän asettelu ja ikonien sijainnit",
  "Saved notes and trash contents": "Tallennetut muistiinpanot ja roskakorin sisältö",
  "Theme, language, and active filters": "Teema, kieli ja aktiiviset suodattimet",
  "Cached desktop data in this browser": "Tähän selaimeen tallennettu työpöytädata",
  "Reset everything": "Nollaa kaikki",
  "Confirm reset": "Vahvista nollaus",
  "Rename note": "Nimea muistiinpano uudelleen",
  "Enter a new filename for this desktop note.": "Anna tälle työpöydän muistiinpanolle uusi tiedostonimi.",
  "This action clears all saved application data in this browser and reloads the desktop.": "Tämä toiminto poistaa kaiken tähän selaimeen tallennetun sovellusdatan ja lataa työpöydän uudelleen.",
  "This cannot be undone.": "Tätä ei voi kumota.",
  Cancel: "Peruuta",
  "Resetting...": "Nollataan...",
